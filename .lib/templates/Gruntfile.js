    ...
    */
    ...
    less: {
      options: {
        ...
        sourceMapRootpath: '/module/themeBtibDark/less/'
      },
      hx: {
        options: {
          sourceMapFilename: 'src/less/maps/hx.map',
          sourceMapURL: '/module/themeBtibDark/less/maps/hx.map'
        },
        files: {
      ...
      ux: {
        options: {
          ...
          sourceMapURL: '/module/themeBtibDark/less/maps/ux.map'
        },
        files: {
